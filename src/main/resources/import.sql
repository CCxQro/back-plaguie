...
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (1, 'ex1@gmail.com', 'gty6qkgWEWdpVYYRJRkHVfyZpPA3', 1, 'Ex1', 1, NULL);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (2, 'Dav@gmail.com', 'GcmYUnDKyzNUf4lzJI3BTBBgrfY2', 1, 'Davicho', 1, NULL);

-- 3.2 Nuevos Administradores (id_rol = 1) -> Total de 5 administradores
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (3, 'admin3@gmail.com', 'pVtLnT4RIjfYL0LtuvaHIZnA6mx2', 1, 'Admin3', 1, NULL);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (4, 'admin4@gmail.com', 'Wou1NFGdTaOFAf4ICaNrd6x2F9i2', 1, 'Admin4', 1, NULL);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (5, 'admin5@gmail.com', '2LTqkEM8P1bZCPbT1ySl5fWymCG3', 1, 'Admin5', 1, NULL);

-- 3.3 Nuevos Agricultores (id_rol = 2) -> Total de 5 agricultores (con ubicación a nivel usuario)
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (6, 'agri1@gmail.com', 'i1TbB18EtlbX8lMT9hGECRXGEUF3', 1, 'AJuan', 2, 1);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (7, 'agri2@gmail.com', 'c2hc3CW2VUT57pc13NpeJWqo24B2', 1, 'AMaria', 2, 2);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (8, 'agri3@gmail.com', 'sltP9g6CzWdPT3MGoztz314i8S42', 1, 'APedro', 2, 3);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (9, 'agri4@gmail.com', 'FJ9QfhyZG1cn4FRUoRccMNjSIFq1', 1, 'ALucia', 2, 4);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (10, 'agri5@gmail.com', 'J8X7wk5XJSXDwJsYIZ26KFtAGbv2', 1, 'ACarlos', 2, 5);

-- 3.4 Nuevos Técnicos Vendedores (id_rol = 3) -> Total de 5 técnicos (con ubicación a nivel usuario)
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (11, 'tec1@gmail.com', 'WyhDU9gb1Mb4CbXxuQFWkDZWVwC3', 1, 'TRoberto', 3, 1);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (12, 'tec2@gmail.com', '3Q3KxUwqJkYmS1tMYdJRr3tvRB03', 1, 'TAna', 3, 2);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (13, 'tec3@gmail.com', 'a5IqtyPATEgwRqxeUjvHsPsubSB3', 1, 'TLuis', 3, 3);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (14, 'tec4@gmail.com', 'eGmuWI2en2ZDI4iGNz0apt812Co2', 1, 'TSofia', 3, 4);
INSERT INTO Usuario (id_usuario, email, uuid_firebase, isActive, nombre, id_rol, id_ubicacion) VALUES (15, 'tec5@gmail.com', 'b4zklFnLY0YhVQsOF0Ht0LcLasw2', 1, 'TJorge', 3, 5);
...
INSERT INTO Tecnico_Vendedor (id_tecnico_vendedor, isActive, id_usuario) VALUES (2, 1, 12);
INSERT INTO Tecnico_Vendedor (id_tecnico_vendedor, isActive, id_usuario) VALUES (3, 1, 13);
INSERT INTO Tecnico_Vendedor (id_tecnico_vendedor, isActive, id_usuario) VALUES (4, 1, 14);
INSERT INTO Tecnico_Vendedor (id_tecnico_vendedor, isActive, id_usuario) VALUES (5, 1, 15);
